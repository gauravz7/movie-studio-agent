...
<figure><img src="media/choice-storyboard-s4.png" alt="3-panel micro-shot"><figcaption>Fan-out → 3-panel micro-shot</figcaption></figure>
...
![A three-shot storyboard — SHOT 1 / 2 / 3, the same cast, wardrobe and light held across all three panels](media/choice-storyboard-s4.png)
